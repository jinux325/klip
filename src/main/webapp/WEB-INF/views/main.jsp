                                                                      ...
                                                                      <td>
                                                                         ...
                                                                         <div class="RadAjaxPanel" id="ctl00_ContentPlaceHolder1_ctl00_ContentPlaceHolder1__projectcodePanel" style="width: 295px; padding-right: 36px; display: inline;">
                                                                            <select id="ctl00_ContentPlaceHolder1__projectcode" class="RadAutoCompleteBox RadAutoCompleteBox_Windows7" style="border: 1px solid #d5d9e0 !important;">
                                                                               ...
                                                                               <option value="value">강남</option>
                                                                               <option value="value">인천</option>
                                                                               <option value="value">지중</option>
                                                                            </select>
                                                                         </div>
                                                                         </span>
                                                                      </td>
                                                        ...
                                                        <div class="RadAjaxPanel" id="ctl00_ContentPlaceHolder1_ctl00_ContentPlaceHolder1_RadGridProjectListPanel" style="display: inline;">
                                                            <div id="ctl00_ContentPlaceHolder1_RadGridProjectList" class="RadGrid RadGrid_Telerik brd_list2" style="width:100%;" tabindex="0">
                                                                <table class="rgMasterTable" id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00" style="width:100%;table-layout:auto;empty-cells:show;">
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            <th scope="col" class="rgHeader" style="white-space:nowrap;">업체코드</th>
                                                                            <th scope="col" class="rgHeader" style="white-space:nowrap;">구분</th>
                                                                            <th scope="col" class="rgHeader" style="white-space:nowrap;">업체명</th>
                                                                            <th scope="col" class="rgHeader" style="white-space:nowrap;">주소</th>
                                                                            <th scope="col" class="rgHeader" style="white-space:nowrap;">낙찰율</th>
                                                                            <th scope="col" class="rgHeader" style="white-space:nowrap;">실행율</th>
                                                                            <th scope="col" class="rgHeader" style="white-space:nowrap;">지입율</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tfoot>
                                                                        <tr class="rgPager">
                                                                    ...
                                                                    <tbody>
                                                                        <!-- <tr class="rgRow" id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00__0" style="white-space:nowrap;">
                                                                            업체코드
                                                                            <td class="col_ct">
                                                                                <a href="#" >00007</a>
                                                                            </td>
                                                                            구분
                                                                            <td class="col_ct">
                                                                                <span id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_lblprojectname">강남</span>
                                                                                <div id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipdocumentno" style="display:none;position:absolute;">
                                                                                    강남
                                                                                    <input id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipdocumentno_ClientState" name="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipdocumentno_ClientState" type="hidden" autocomplete="off">
                                                                                </div>
                                                                            </td>
                                                                            업체명
                                                                            <td class="col_ct">
                                                                                <span id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_lblcustomername">세안이엔씨(주)</span>
                                                                                <div id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipcustomername" style="display:none;position:absolute;">
                                                                                    세안이엔씨(주)
                                                                                    <input id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipcustomername_ClientState" name="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipcustomername_ClientState" type="hidden" autocomplete="off">
                                                                                </div>
                                                                            </td>
                                                                            주소
                                                                            <td class="col_ct">&nbsp;</td>
                                                                            낙찰율
                                                                            <td class="col_ct">86.27%</td>
                                                                            실행율
                                                                            <td class="col_ct">80.00%</td>
                                                                            지입율
                                                                        ...
                                                                        <c:forEach items="${requestScope.list }" var="item">
                                                                        	<tr class="rgRow" id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00__0" style="white-space:nowrap;">
	                                                                            ...
	                                                                            <!-- 구분 -->
	                                                                            <td class="col_ct">
	                                                                                <span id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_lblprojectname">${item.division }</span>
	                                                                                <div id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipdocumentno" style="display:none;position:absolute;">
	                                                                                    ${item.division }
	                                                                                    <input id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipdocumentno_ClientState" name="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipdocumentno_ClientState" type="hidden" autocomplete="off">
	                                                                                </div>
	                                                                            ...
	                                                                            <!-- 업체명 -->
	                                                                            <td class="col_ct">
	                                                                                <span id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_lblcustomername">${item.name }</span>
	                                                                                <div id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipcustomername" style="display:none;position:absolute;">
	                                                                                    ${item.name }
	                                                                                    <input id="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipcustomername_ClientState" name="ctl00_ContentPlaceHolder1_RadGridProjectList_ctl00_ctl04_RadToolTipcustomername_ClientState" type="hidden" autocomplete="off">
	                                                                                </div>
	                                                                            ...
	                                                                            <!-- 주소 -->
	                                                                            <td class="col_ct">${item.address }</td>
	                                                                            <!-- 낙찰율 -->
	                                                                            <td class="col_ct">${item.ratio_bid }%</td>
	                                                                            <!-- 실행율 -->
	                                                                            <td class="col_ct">${item.ratio_run }%</td>
	                                                                            <!-- 지입율 -->
	                                                                            <td class="col_ct">${item.ratio_bring }%</td>
	                                                                        </tr>
                                                                        </c:forEach>
                                                                    </tbody>
                                                                </table>
