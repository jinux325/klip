...
$(function(){
	...
	$(menu2).has("ul").children("span").css({
		backgroundImage : "url('../images/common/tit_nav_ic_off.png')",
	...
	$(menu2).on("mouseenter", function(){
		...
		$(this).has("ul").children("span").css({
			backgroundImage : "url('../images/common/tit_nav_ic_on.png')",
		});
	});
...
$(function () {
	...
	$(".search_box .search_btn .RadButton input.rbDecorated").each(function () {
		$(this).on({
			"click": function () {
				if ($(".btn_openline1").is(".on")) {
					$(".btn_openline1").removeClass("on");
	...
	$(document).ready(function () {
		$('body').on('keydown', 'input, select', function (e) {
			...
			if (key == 13) {
				...
				//}
				//else {
				//	if (next.width() <= 1) {	//�ڷ��� RadDatePicker�� WIDTH=1�� INPUT ����
